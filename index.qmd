...
- De acuerdo con las recomendaciones de Naciones Unidas (2009):
    
    > Se concibe como una base común, estable y coherente para múltiples encuestas o rondas repetidas de una misma operación estadística, garantizando trazabilidad y consistencia temporal.
...
- El diseño muestral de la II ENUT implica la obtención de una muestra probabilística estratificada y bietápica.
  ...
  - En la segunda etapa se selecciona la *Unidad Secundaria de Muestreo* (viviendas), la cual tiene igual probabilidad de selección al interior de cada UPM.
...
- Cada una de las viviendas seleccionadas dentro de la UPM en el estrato 'A', representa a 300 viviendas similares de la población.
